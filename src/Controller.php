...
use luomor\openapidoc\parses\ParseApiDetail;
use luomor\openapidoc\parses\ParseCodeTemplate;
use luomor\openapidoc\parses\ParseApiMenus;
use luomor\openapidoc\parses\ParseMarkdown;
use luomor\openapidoc\utils\ApiShare;
use luomor\openapidoc\utils\Cache;
use luomor\openapidoc\utils\ConfigProvider;
use luomor\openapidoc\utils\DirAndFile;
use luomor\openapidoc\utils\Helper;
use luomor\openapidoc\utils\Lang;
use luomor\openapidoc\utils\Request;
use luomor\openapidoc\exception\ErrorException;
...
class Controller
{
    ...
    public function init($checkAuth = false)
    {
        ...
        if (isset($this->config['enable']) && $this->config['enable'] === false) {
            throw new ErrorException("openapidoc close");
        }
