...
namespace luomor\openapidoc\providers;

use luomor\openapidoc\middleware\LaravelMiddleware;
...
use Exception;
use luomor\openapidoc\utils\ApiCrossDomain;
...
class LaravelService extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../config.php' => config_path('openapidoc.php'),
        ]);
    }
